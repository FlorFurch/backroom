...
define( "RECIPIENT_NAME", "Rei" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "reinaldo@estudiobackroom.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Mensaje desde la web" ); //UPDATE THIS TO YOUR SUBJECT
